  ...
  return (
    <>
      <div class="Footer_wrapper">
        <div class="Footer_contentRow">
          <div class="fcol-1">
            <div class="Footer_title">Products</div>
            <div class="Footer_subtitle">Accepts payments</div>
            <div class="Footer_subtitle">Make Payments</div>
            <div class="Footer_subtitle">POS Terminals</div>
          </div>
          <div class="fcol-2">
            <div class="Footer_title">Business Types</div>
            <div class="Footer_subtitle">Mobile Money Agents</div>
            <div class="Footer_subtitle">Small Business</div>
            <div class="Footer_subtitle">Large Business</div>
          </div>
        </div>

        <div class="Footer_contentRow">
          <div class="fcol-1">
            <div class="Footer_title">Nomba</div>
            <div class="Footer_subtitle">About us</div>
            <div class="Footer_subtitle">Blogs</div>
            <div class="Footer_subtitle">Work with Nomba</div>
          </div>
          <div class="fcol-2">
            <div class="Footer_title">Follow us</div>
            <div class="Footer_subtitle">Instagram</div>
            <div class="Footer_subtitle">Twitter</div>
            <div class="Footer_subtitle">Youtube</div>
            <div class="Footer_subtitle">Facebook</div>
          </div>
        </div>
        <div class="Footer_contentRow">
          <div class="fcol-1">
            <div class="Footer_title">Contact us</div>
            <div class="Footer_subtitle">018888866</div>
            <div class="Footer_subtitle">015200061</div>
            <div class="Footer_subtitle">support@nomba.com</div>
          </div>
        </div>
        ...
        <div class="Footer_contentRow">
          <div class="fcol-1">
            ...
            <div class="Footer_subRow">
              <div class="Footer_subtitle">Privacy Policy</div>
              <div class="Footer_subtitle spacer">Terms of Service</div>
            </div>
          </div>
        </div>
      </div>
